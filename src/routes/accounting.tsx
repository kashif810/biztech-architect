...
import { LayoutGrid, Users, Truck, FileText, Receipt, Wallet, Settings, ClipboardList, BookOpen, CreditCard } from "lucide-react";
...
const NAV = [
  ...
  { to: "/accounting/expenses", label: "Expenses", icon: CreditCard },
